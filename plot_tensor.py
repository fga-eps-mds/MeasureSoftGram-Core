...
TMT1_Modificabilidade = np.array([[0.068], [0.017], [0.075]])
...
TMT1_SubCarac = np.array([[0.102], [0.4], [0.25]])
normTMT1_SubCarac = np.linalg.norm(ts.base.tensor_to_vec(TMT1_SubCarac))
print('A norma(Frobenius) das subcaracteríticas de TMT1 = '+ str(normTMT1_SubCarac) + '\n' )
