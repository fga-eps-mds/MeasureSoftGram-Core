from src.core import interpretation_functions as functions
...
INVALID_METRICS_TEST_DATA = [
    (functions.non_complex_files_density,
        'tests/unit/data/zero_number_of_files.json', 'The number of files is lesser or equal than 0'),
    (functions.non_complex_files_density, 'tests/unit/data/zero_number_of_functions.json',
        'The number of functions of all files is lesser or equal than 0'),
    (functions.non_complex_files_density, 'tests/unit/data/zero_cyclomatic_complexity.json',
        'The cyclomatic complexity of all files is lesser or equal than 0'),
    (functions.commented_files_density,
        'tests/unit/data/zero_number_of_files.json', 'The number of files is lesser or equal than 0'),
    (functions.absence_of_duplications,
        'tests/unit/data/zero_number_of_files.json', 'The number of files is lesser or equal than 0'),
]
...
SUCCESS_TEST_DATA = [
    ...
    (functions.non_complex_files_density,
        'tests/unit/data/fga-eps-mds-2020_2-Lend.it-Raleway-user-13-04-2021.json', 0.6428571428571429),
    (functions.commented_files_density,
        'tests/unit/data/fga-eps-mds-2020_2-Projeto-Kokama-Usuario-17-04-2021.json', 0.0),
    (functions.commented_files_density,
        'tests/unit/data/fga-eps-mds_2021-2-SiGeD-Frontend-03-15-2022-23_57_08.json', 0.005988023952095809),
    (functions.commented_files_density,
        'tests/unit/data/fga-eps-mds-2020_2-Lend.it-Raleway-user-13-04-2021.json', 0.0),
    (functions.absence_of_duplications,
        'tests/unit/data/fga-eps-mds_2021-2-SiGeD-Frontend-03-15-2022-23_57_08.json', 0.9101796407185628),
    (functions.absence_of_duplications,
        'tests/unit/data/fga-eps-mds-2020_2-Projeto-Kokama-Usuario-17-04-2021.json', 1.0),
    (functions.absence_of_duplications,
        'tests/unit/data/fga-eps-mds-2020_2-Lend.it-Raleway-user-13-04-2021.json', 1.0)
]


INVALID_ARGUMENTS_TEST_DATA = [
    (functions.non_complex_files_density, None),
    (functions.non_complex_files_density, False),
    (functions.non_complex_files_density, pd.Series(data={'a': 1, 'b': 2, 'c': 3}, index=['a', 'b', 'c'])),
    (functions.commented_files_density, None),
    (functions.commented_files_density, False),
    (functions.commented_files_density, pd.Series(data={'a': 1, 'b': 2, 'c': 3}, index=['a', 'b', 'c'])),
    (functions.absence_of_duplications, None),
    (functions.absence_of_duplications, False),
    (functions.absence_of_duplications, pd.Series(data={'a': 1, 'b': 2, 'c': 3}, index=['a', 'b', 'c']))
]
...
def test_interpretation_functions_invalid_metrics(interpretation_func, file_path, error_msg):
    ...
    function_call = f"{interpretation_func.__name__}(create_file_df('{file_path.split('/')[-1]}'))"

    assert_msg = f"Expected: {function_call} to raise an InvalidMetricValue('{error_msg}')"
...
def test_non_complex_files_density_error_arguments(interpretation_func, data_frame):
    ...
    assert str(
        error.value) == error_msg, f"Expected: {function_call} to raise an InvalidInterpretationFunctionArguments"
